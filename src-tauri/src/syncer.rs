...
pub struct ClientMessage {
    ...
    pub r#type: i32,
    #[prost(oneof = "client_message::Payload", tags = "5, 6, 7")]
...
pub mod message_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn is_connected(
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("syncer.MessageService", "IsConnected"));
            self.inner.unary(req, path, codec).await
        }
    }
}
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/syncer.MessageService/StreamMessages" => {
                    ...
                    impl<
                        T: MessageService,
                    > tonic::server::ServerStreamingService<super::ClientMessage>
                ...
                "/syncer.MessageService/SendMessage" => {
                    ...
                    impl<
                        T: MessageService,
                    > tonic::server::UnaryService<super::ClientMessage>
                ...
                "/syncer.MessageService/IsConnected" => {
                    #[allow(non_camel_case_types)]
                    struct IsConnectedSvc<T: MessageService>(pub Arc<T>);
                    ...
                    for IsConnectedSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MessageService>::is_connected(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
